...
Fraction Fraction::operator+(int num) const {
  Fraction fraction = *this;
  fraction.numerator += (num * fraction.denominator);
  return fraction;
...
Fraction operator+(int num, const Fraction &other) {
    Fraction fraction;
    fraction.set(other.numerator + (other.denominator * num), other.denominator);
    return fraction;
}

Fraction operator-(int num, const Fraction &other) {
    Fraction fraction;
    fraction.set((num * other.denominator) - other.numerator, other.denominator);
    return fraction;
}
